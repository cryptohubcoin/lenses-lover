...
(function(){
  ...
  var CATALOG=[
    {ar:'وميض العسل',en:'Honey Glow',c1:'#e8b36b',c2:'#8c5a24',ring:'#5c3a18',ar_m:'عسلي · يومي',en_m:'Honey · Daily',price:399},
    {ar:'ستار الزمرد',en:'Emerald Veil',c1:'#7fbf9e',c2:'#1f5c42',ring:'#123626',ar_m:'زمردي · شهري',en_m:'Emerald · Monthly',price:450},
    {ar:'ضباب المحيط',en:'Ocean Mist',c1:'#7fa8c9',c2:'#28516e',ring:'#1a3244',ar_m:'أزرق · يومي',en_m:'Ocean · Daily',price:350},
    {ar:'همسة الفجر',en:'Dawn Whisper',c1:'#c9a15b',c2:'#6b4a24',ring:'#4a2f17',ar_m:'بندقي · سنوي',en_m:'Hazel · Yearly',price:780},
    {ar:'رماد القمر',en:'Moon Ash',c1:'#b9c0c6',c2:'#5b6670',ring:'#394048',ar_m:'رمادي · شهري',en_m:'Ash · Monthly',price:430},
    {ar:'غابة الزيتون',en:'Olive Grove',c1:'#9faf6e',c2:'#4b5a2e',ring:'#333d1e',ar_m:'زيتوني · يومي',en_m:'Olive · Daily',price:370},
    {ar:'حلم وردي',en:'Rose Dream',c1:'#d99a8f',c2:'#8a4a3e',ring:'#5c2e26',ar_m:'وردي · شهري',en_m:'Rose · Monthly',price:460},
    {ar:'شفق بنفسجي',en:'Violet Dusk',c1:'#b49ad1',c2:'#5a3f7a',ring:'#3a274f',ar_m:'بنفسجي · سنوي',en_m:'Violet · Yearly',price:820}
  ];
  ...
  trust.innerHTML='<div class="track"><div class="row">'+
      ...
      '<span><span class="ic">↩</span><span class="ar">استرجاع خلال <b>١٤ يوم</b></span><span class="en">14-day returns</span></span>'+
  ...
  function renderDrawer(){
    ...
    foot.innerHTML=
      ...
      '<div class="ll-dsum"><span><span class="ar">الإجمالي</span><span class="en">Subtotal</span></span><span>'+money(sub)+'</span></div>'+
  ...
  function renderSearch(q){
    ...
    list.slice(0,6).forEach(function(p){
      var a=document.createElement('a'); a.className='ll-sr'; a.href='lenses-lover-product.html';
      a.innerHTML='<div class="th" style="--c1:'+p.c1+';--c2:'+p.c2+';--ring:'+p.ring+'"><div class="pupil"></div></div>'+
